...
ip_addr = str(input("Enter IP address or web address:"))
...
# If user's input is 4, perform a Regular Scan
    ...
    print(scanner.scan("ums.lpu.in", arguments="-O")['scan']['ums.lpu.in']['osmatch'])
    ...
    scanner.scan(hosts='127.0.0.1/24', arguments='-n -sP -PE -PA21,23,80,3389')
